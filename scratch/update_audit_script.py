...
target_path = r"c:\Users\lpk naidu\OneDrive\Desktop\Finance ed hub\sql\phase0_bulletproof_audit.sql"
with open(target_path, "w", encoding="utf-8") as f:
    f.write(sql_content)
print("Updated sql/phase0_bulletproof_audit.sql successfully.")
