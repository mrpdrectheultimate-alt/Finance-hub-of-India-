-- ============================================================
-- FinanceHub — Phase 0: Complete Reality Audit (Schema-Aligned v2)
...
SELECT
  ...
  ROUND(AVG(xp_earned),1)  AS avg_xp_per_completion,
...
SELECT
  ...
  ROUND(100.0*COUNT(CASE WHEN passed=TRUE THEN 1 END)
...
-- ─────────────────────────────────────────────────────────────
-- AUDIT 18: SUBSCRIPTION / PAYMENT STATUS
-- ─────────────────────────────────────────────────────────────
SELECT
...
-- ─────────────────────────────────────────────────────────────
-- AUDIT 19: COMPLETE SUMMARY REPORT
-- ─────────────────────────────────────────────────────────────
...
UNION ALL
SELECT
  'Total Quiz Attempts: ' || COUNT(*)::TEXT,
  NULL
FROM user_quiz_attempts
